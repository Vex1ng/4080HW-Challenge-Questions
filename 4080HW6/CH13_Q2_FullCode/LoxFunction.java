...
LoxFunction bind(LoxInstance instance, LoxClass ownerClass) {
  Environment environment = new Environment(closure);
  environment.define("this", instance);
  environment.define("__inner_class__", ownerClass);
  String name = (declaration.name != null) ? declaration.name.lexeme : "";
  environment.define("__inner_name__", name);
